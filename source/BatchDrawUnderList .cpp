...
void BatchDrawUnderList::Clear(int step, double zoom)
{
	data.clear();
	this->step = step;
	this->zoom = zoom;
...
void BatchDrawUnderList::SetCenter(const Point &center)
{
	this->center = center;
}
...
bool BatchDrawUnderList::Add(const Body &body, float clip)
{
...
bool BatchDrawUnderList::AddVisual(const Body &visual)
{
...
void BatchDrawUnderList::Draw() const
{
	BatchShader::Bind();
...
bool BatchDrawUnderList::Cull(const Body &body, const Point &position) const
{
...
bool BatchDrawUnderList::Add(const Body &body, Point position, float clip)
{
