...
const Command Command::LATERALLEFT(ONE << 36, "Lateral left thrust");
const Command Command::LATERALRIGHT(ONE << 37, "Lateral right thrust");
const Command Command::WAIT(ONE << 38, "");
const Command Command::STOP(ONE << 39, "");
const Command Command::SHIFT(ONE << 40, "");
const Command Command::CTRL(ONE << 41, "");
