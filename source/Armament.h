...
public:
	...
	void AddGunPort(const Point &point, const Angle &angle, bool isParallel, bool isUnder, bool isDefensive, const Outfit *outfit = nullptr);
	void AddTurret(const Point &point, const Angle &angle, bool isUnder, bool isDefensive, const Outfit *outfit = nullptr);
	void AddPylon(const Point &point, bool isUnder, const Outfit *outfit = nullptr);
